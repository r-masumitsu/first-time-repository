...
room_name VARCHAR(255) NOT NULL, PRIMARY KEY (room_id))/;
...
CREATE TABLE IF NOT EXISTS reservation (reservation_id SERIAL NOT NULL, end_time TIME NOT NULL, start_time TIME NOT NULL, reserved_date DATE NOT NULL, room_id INT4 NOT NULL, user_id VARCHAR(255) NOT NULL, comment VARCHAR(255) NOT NULL, online BOOLEAN NOT NULL, PRIMARY KEY (reservation_id))/;
