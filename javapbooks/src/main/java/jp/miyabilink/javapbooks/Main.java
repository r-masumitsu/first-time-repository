...
public class Main {
	/**
	 * Bookの削除・並べ替え・複製を行うメソッド。
	 * * @param args メインメソッド引数
	 */
	public static void main(String[] args) {
		...
		Book book5 = new Book("聖書", new Date(100, 8, 8), "キリスト");
		Book book6 = new Book("聖書", new Date(100, 8, 8), "イエス");
		...
		//聖書を削除
		//「書籍と発行日とコメントが同じであれば等価なものと判定され」るように改変した
		//bookSet.remove(book5);
		bookSet.remove(book6);
		//セットの中身を表示
